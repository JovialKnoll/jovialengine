...
class Display(object):
    ...
    def __init__(self):
        ...
        self._setupDisplay()
        self.is_fullscreen = jovialengine.shared.config.getboolean(jovialengine.engineconstants.CONFIG_SECTION, jovialengine.engineconstants.CONFIG_FULLSCREEN)
        self.upscale = jovialengine.shared.config.getint(jovialengine.engineconstants.CONFIG_SECTION, jovialengine.engineconstants.CONFIG_SCREEN_SCALE)
        ...
        jovialengine.shared.config.set(jovialengine.engineconstants.CONFIG_SECTION, jovialengine.engineconstants.CONFIG_SCREEN_SCALE, str(self.upscale))
    ...
    def toggleFullscreen(self):
        ...
        if self.is_fullscreen:
            ...
            self._setWindowed()
        self.screen = self.screen.convert(self._disp_screen)
        jovialengine.shared.config.set(jovialengine.engineconstants.CONFIG_SECTION, jovialengine.engineconstants.CONFIG_FULLSCREEN, str(self.is_fullscreen))
